...
import { Venturesdetailsdescriptiontext } from "./venturesdetailsdescriptiontext";
import { VenturesDetailsImgItem } from "./venturesdetailsimgitem";

type Props = {
  venturesData: any;
};

export const VenturesDetailsItem = ({ venturesData }: Props) => {
    ...
    <div style={{ paddingLeft: "5%", paddingRight: "5%" }}>
      ...
      <div className="w-full items-center justify-center flex sm:mb-40 mb-20">
        <div className="sm:w-3/5 w-full">
          ...
          {venturesData?.subdescription.map(
            (
